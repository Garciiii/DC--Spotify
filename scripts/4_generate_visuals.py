...
# Inicializa lista para ranking de utilizadores
ranking = []

# Processa cada pasta de utilizador
for user_dir in RAW_DIR.iterdir():
    if user_dir.is_dir():
        ...
        # Gráfico 1: Top 10 músicas por minutos
        ...
        # Gráfico 2: Top artistas por minutos (simulado pela média de durações)
        ...
        # Gráfico 3: Top gêneros por frequência
        plt.figure(figsize=(12, 6))
...
# Ranking geral dos utilizadores
